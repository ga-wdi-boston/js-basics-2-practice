...
let endIndex;
let distance;
// if same line, compute absolute value of difference between array indices
if (startLine === endLine) {
  ...
  // if different lines, compute absolute value of difference betwen first
  //stop's array index and Park Street index on that line, PLUS same calculation
  //for the end station.
  startIndex = mbta[startLine].indexOf(startStation);
