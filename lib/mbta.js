...
var stopsBetweenStations = function stopsBetweenStations(startLine, startStation, endLine, endStation) {
  if(startLine !== endLine){
    var part1 = Math.abs(startLine.indexOf(startStation) - startLine.indexOf('parkStreet'));
    var part2 = Math.abs(endLine.indexOf('parkStreet') - endLine.indexOf(endStation));
    return part1 + part2;
  }
