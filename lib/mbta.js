...
const mbtaSystem = {
  ...
  'Green':
    ["Kenmore", "Hynes", "Copley", "Arlington", "Boylston", "Park Street", "Haymarket", "Government Center"],
  'Orange':
    ["Forest Hills", "Back Bay", "Chinatown", "Downtown Crossing", "State", "Park Street", "Haymarket", "North Station"]
}
...
const stopsBetweenStations = function(startLine, startStation, endLine, endStation) {
  if (startLine === endLine) {
    ...
    return stopsNoXfr(startLine,startStation,"Park Street") + stopsNoXfr(endLine,"Park Street",endStation);
  }
};
