...
const mbtaSubway = {
  ...
  orangeLine: ['North Station', 'Haymarket', 'Park Street', 'State', 'Downtown Crossing', 'Chinatown', 'Backbay', 'Forest Hills']
}
let startIndex
let endIndex
let numberOfStops
...
// stopsBetweenStations(redLine, 'Harvard', orangeLine, 'Backbay')
